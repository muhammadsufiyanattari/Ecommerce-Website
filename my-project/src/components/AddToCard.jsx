  ...
  return (
    <>
      <Link id={id} to={`/productDetail/${id}`}>
        <div data-aos="flip-left" className={ `${darkMode?"darkTheme":""} main group bg-white drop-shadow-lg shadow-black   w-[270px] h-[370px] my-4 rounded mobile:m-auto transition-all duration-300 `}>
