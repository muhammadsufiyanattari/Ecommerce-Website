    ...
    <>
     ...
     data-aos-anchor-placement="bottom-bottom" className="flex font-semibold gap-2 items-center text-base text-myTheme">
          ...
          <div className="flex gap-6  2xl:gap-6 xl:gap-6 lg:gap-6 md:gap-6 sm:gap-6 mobile:gap-6 " >
            <div data-aos="fade-up "
     data-aos-anchor-placement="bottom-bottom" className={` ${darkMode?"text-white":""}  font-semibold  2xl:text-3xl xl:text-3xl lg:text-3xl md:text-3xl sm:text-xl mobile:text-sm leading-[48px]`}>
              {" "}
              Flash Sales
            </div>
            <div className="flex flex-col gap-0 ">
              <div data-aos="fade-left" className={`${darkMode?"text-white":""}  flex gap-7  2xl:gap-7 xl:gap-7 lg:gap-7 md:gap-7 sm:gap-4 mobile:gap-4 font-medium text-xs   2xl:text-xs xl:text-xs lg:text-xs md:text-xs sm:text-[8px] mobile:text-[8px]`}>
                <span>Days</span>
                <span>Hours</span>
                <span>Mintus</span>
                <span>Secand</span>
