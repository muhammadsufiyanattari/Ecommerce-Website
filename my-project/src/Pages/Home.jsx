    ...
    <div id="mainhome"  className={` ${darkMode?"pageDark":""} transition-colors duration-500  flex flex-col justify-center `}>
     ...
     <Hero   />
      ...
      <div className="center  gap-[88px] my-24 2xl:flex-row xl:flex-row lg:flex-row md:flex-col sm:flex-col mobile:flex-col ">
        <div data-aos="zoom-in" className="flex flex-col gap-6 justify-center items-center">
          <div className={`${darkMode?"bg-white":""}  bg-gray-400 rounded-full p-1 cursor-none`}>
            {" "}
          ...
          <div data-aos="zoom-in-right"  className="center flex-col">
            <h2 className={`${darkMode?"text-white":""}  font-semibold text-xl text-black`}>
              FREE AND FAST DELIVERY
            </h2>
            <h3 className={`${darkMode?"text-white":""}  font-normal text-sm text-black`}>
